...
class DrawingSizeParams:
    ...
    def change_paper_size(self, new_paper_size: PaperSize) -> "DrawingSizeParams":
        ...
        return DrawingSizeParams(text_fontsize=self.text_fontsize*scale,
    ...
    @staticmethod
    def default(paper_size: PaperSize) -> 'DrawingSizeParams':
