#!/usr/bin/python3
"""Parameters for Multi Mountain Posters."""
...
class MultiMountainParams:
    ...
    @staticmethod
    def default() -> "MultiMountainParams":
        """Default Multi Mountain Parameters."""
        return MultiMountainParams(
            track_lw=A4Float(mm=1.0),
            track_color="white",
            scatter_params={
                ScatterPointCategory.MOUNTAIN_HUT: ScatterParams(markersize=A4Float(mm=3.5),
                                                                 marker=MarkerType.HOUSE,
                                                                 color="m"),
            ...
            annot_params={
                ScatterPointCategory.MOUNTAIN_HUT: AnnotatedScatterParams(arrow_linewidth=A4Float(mm=0.5),
